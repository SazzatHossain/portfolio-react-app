...
const Home = () => {
  return (
    <>
      <div
        className='flex flex-col items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover custom-cover-img'>
        <div className='absolute top-0 right-0 bottom-0 w-full bg-black/60 z-[2]'/>
        <h1 className='text-white uppercase z-10'>Hi, I'm <span className='text-orange-600'>Sazzat Hossain</span></h1>
        <h2 className='text-white uppercase z-10'>A Full-Stack developer </h2>
        <p className='text-white z-10 py-6 w-[700px] text-center'>I'm currently working at <span
        ...
        <div className='flex flex-row items-center justify-between  mx-auto py-4'>
          <a
            className='rounded-full shadow-lg p-6 mx-8 shadow-gray-800 cursor-pointer z-10 bg-white hover: scale-110 ease-in duration-300'
